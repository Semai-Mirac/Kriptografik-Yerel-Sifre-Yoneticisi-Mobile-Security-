...
class AppLocalizations {
  ...
  static const Map<String, Map<String, String>> _localizedValues = {
    ...
    'it': {
      ...
      'restoreFailedPrefix': 'Ripristino non riuscito',
      'confirmRestoreTitle': 'Conferma ripristino',
      'confirmRestoreBody': 'Tutte le password esistenti verranno eliminate e sostituite con quelle sottoposte a backup. Sei sicuro?',
    ...
    'ko': {
      ...
      'restoreFailedPrefix': '복원 실패',
      'confirmRestoreTitle': '복원 확인',
      'confirmRestoreBody': '모든 기존 비밀번호가 삭제되고 백업된 비밀번호로 교체됩니다. 확실합니까?',
